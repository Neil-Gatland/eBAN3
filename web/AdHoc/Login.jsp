...
<%
    ...
    String system = request.getParameter("system")==null?"AdHoc":(String)request.getParameter("system");
...
window.name="ahmain";
  ...
  {
    document.forms[0].username.value = "Guest";
    document.forms[0].userpass.value = "Guest";
	...
	<!-- this is a spacer column-->
	  ...
	  <td  valign ="Top"><a name="content"></a>
		...
		<td valign="top" height="45" width="598"  colspan=3>
		  <h1>Welcome to Ad Hoc Billing</h1>
		...
		<tr>
			...
			if (session.getAttribute("Error") != null )
			{
		      ...
		      <tr>
                        <td colspan=3>
                          <%=HTMLB.getImageAsAnchor("guestlogin", text)%>
                        </td>
		      </tr>
		      <tr>
                        <td colspan=3>
