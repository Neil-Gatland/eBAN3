...
<jsp:useBean id="DBA" class="DBUtilities.DBAccess" scope="session"/>
  ...
  <tr><!-- This row holds the local menu bar-->
      <td>
	<form name="CustomerBAN" method="post" action="AccountBANHandler.jsp">
        <%=HB.getBANMenu_Bar("BAN",Mode,Action)%>
	  ...
	  <tr>
		...
		<tr>
		  <td valign="top" colspan=2>
			...
			<td  class=<%=cuBAN.getClass("Invoice_Region")%>><b><small>Invoice Region Name
