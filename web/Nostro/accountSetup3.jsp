...
%>
  ...
  <table id=1 width ="100%">
    ...
    <tr>
      <td colspan=3>
      <form name="accountSetup" method="post" action="accountSetupHandler.jsp?page=3">
      <%=HB.getBANMenu_Bar("Test3","","",(String)session.getAttribute("System"))%>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" id=2>
	  <tr>
	    ...
	    <td valign="top">
	      <h3 align="center"><b>Account Set-up (3) - e-billing</b></h3>
	       <%=Message%><br>
		...
		<tr>
		  <td align=left colspan=2><font color="#0000FF">Accounts</font>
		  </td>
		  <td align=left colspan=2><font color="#0000FF">Users</font>
		  </td>
		</tr>
		<tr>
		...
		<tr>
		  <td align=left><font color="#0000FF">Customer Given Name</font>
		  </td>
		  <td align=left><font color="#0000FF">Customer Surname</font>
		  </td>
		...
		<tr>
		  <td align=left>Customer Job Title
		  </td>
		  <td align=left><font color="#0000FF">Primary Recipient?</font>
		  </td>
		</tr>
		<tr>
		  <td align=left>
		...
		<tr>
		  <td align=left>Customer Contact Number
		  </td>
		  <td align=left colspan=2><font color="#0000FF">Customer e-mail Address</font>
		  </td>
		</tr>
		<tr>
		  <td align=left>
		  ...
		  <td align=left colspan=2>
		    <input class=inp type=text name="BC_Reference" size="70">
		  </td>
		</tr>
	      </table>
		</form>
