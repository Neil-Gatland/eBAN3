...
<% String SQL;
    ...
    String Options[][] = {{"Log Off","Conglom Desktop","Conglom Billing Menu"},
                            {"Refresh","Add","Apply Lead Discount","Raise Query"}};
    ...
    String title = "List Conglomerate Manual Source Invoices";
    %>
...
function Toggle_Sort(buttonPressed)
{
  ...
  {
    window.open("conglomManualInvoicesKey.htm", "ndk", "toolbar=no,menubar=no,location=no," +
      "directories=no,status=no,scrollbars=no,resizable=no,height=200,width=200,top=50,left=50");
  }
}
</script>
<form name="listConglomManualInvoices" method="post" action="listConglomManualInvoicesHandler.jsp">
	...
	<td valign="top" id=2>
	  ...
	  <table width="100%" border="0" id=3>
	    <tr>
	      ...
	      <%
	        session.setAttribute("formname","listConglomManualInvoices");
	      %>
                ...
                <table border=0 width=70% align="center">
                  <tr class=gridHeader>
                    ...
                    <td class=gridHeader NOWRAP valign=top width=90>
                      <button class=grid_menu>Bill Date</button>
                    </td>
                    <td class=gridHeader NOWRAP valign=top width=90>
                      <button class=grid_menu>Invoice Total</button>
                    </td>
                  ...
                  <tr>
                    <td colspan=8>
	        <iframe frameborder=0 width="100%" height=250 id=GridData name=GridData src="conglomManualInvoiceGrid.jsp"></iframe>
                    </td>
                  </tr>
                </table>
	      </td>
