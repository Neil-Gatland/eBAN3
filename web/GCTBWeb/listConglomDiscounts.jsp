...
<% String SQL;
    ...
    String title = "List Conglomerate Product Discounts";
    %>
...
function Toggle_Sort(buttonPressed)
{
  ...
  {
    window.open("conglomDiscountKey.htm", "ndk", "toolbar=no,menubar=no,location=no," +
      "directories=no,status=no,scrollbars=no,resizable=no,height=200,width=200,top=50,left=50");
  }
}
</script>
<form name="listConglomDiscounts" method="post" action="listConglomDiscountsHandler.jsp">
	...
	<td valign="top" id=2>
	  ...
	  <table width="100%" border="0" id=3>
	    <tr>
	      ...
	      <%
	        session.setAttribute("formname","listConglomDiscounts");
	      %>
                ...
                <table border=0 width=100%>
                  <tr class=gridHeader>
                    ...
                    <td class=gridHeader NOWRAP valign=top width=120>
                      <button class=grid_menu>Discount Type</button>
                    </td>
                    <td class=gridHeader NOWRAP valign=top width=130>
                      <button class=grid_menu>Discount Percentage</button>
                    </td>
                    <td class=gridHeader NOWRAP valign=top width=130>
                      <button class=grid_menu>Applied To Percentage</button>
                    </td>
                    <td class=gridHeader NOWRAP valign=top width=90>
                      <button class=grid_menu>Effective From</button>
                    </td>
                    <td class=gridHeader NOWRAP valign=top width=90>
                      <button class=grid_menu>Effective To</button>
                    </td>
                    <td class=gridHeader NOWRAP valign=top width=90>
                      <button class=grid_menu>Accrued To</button>
                    </td>
                  ...
                  <tr>
                    <td colspan=8>
	        <iframe frameborder=0 width="100%" height=250 id=GridData name=GridData src="conglomDiscountGrid.jsp"></iframe>
                    </td>
                  </tr>
                </table>
	      </td>
