...
//
    ...
    if ((session != null) && (request.getParameter("keepSession")==null))
      session.invalidate();
...
{
  window.open("resetPassword.jsp?username="+frmLogin.username.value, "resetPass", "toolbar=no,menubar=no,location=no," +
   ...
   <tr><td>
	...
	<!-- this is a spacer column-->
	  ...
	  <td  valign ="Top"><a name="content"></a>
		...
		<form name="frmLogin" method="post" action="Authenticate.jsp">
		<tr>
		  <td>Username: </td>
		  <td>Password: </td>
		  <td width=100>&nbsp; </td>
		...
		<tr>
		  ...
		  <td>
  		  ...
  		  <td>
                    Change <input type=checkbox name="chgPass">
	 	  </td>
		</tr>
                <tr>
  		  <td colspan=3>
			...
			<td colspan=2><font color=red><b><%=error%>
		      ...
		      <tr>
                        <td colspan=3 class="Instructions">
                          ...
                          <A HREF='javascript:resetPassword()'>here</A>
                        </td>
		      </tr>
		      <tr>
                        <td colspan=3 class="Instructions">
