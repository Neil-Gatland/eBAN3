...
<%
    ...
    String system = request.getParameter("system")==null?"LLU":(String)request.getParameter("system");
    ...
    String text = "For temporary, read-only access to LLU Circuit Maintenance. " +
    " If you require a LLU user profile please contact '" + email + "'";
%>
	...
	<!-- this is a spacer column-->
	  ...
	  <td  valign ="Top"><a name="content"></a>
		...
		<td valign="top" height="45" width="598"  colspan=3>
		  <h1>Welcome to LLU Circuit Maintenance</h1>
