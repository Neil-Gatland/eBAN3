...
function Toggle_Sort(buttonPressed)
{
  ...
  {
    window.open("manualAdjustmentInvoicingKey.htm", "mak", "toolbar=no,menubar=no,location=no," +
      "directories=no,status=no,scrollbars=no,resizable=no,height=200,width=300,top=50,left=50");
  }
}
</script>
<form name="manualAdjustmentInvoicing" method="post" action="manualAdjustmentInvoicingHandler.jsp">
...
<table id=1 border=0 width="100%">
  ...
  <tr>
   <td colspan=3>
	...
	<td valign="top" id=2>
	  <h3 align="center">Manual Adjustment Invoicing</h3>
        ...
        <table border=0 width="100%">
          <tr class=gridHeader>
            ...
            <td class=gridHeader NOWRAP valign=top width="85">
              <button class=grid_menu>Tax Point Date</button>
            </td>
            <td class=gridHeader NOWRAP valign=top width="305">
...
-->
            <td class=gridHeader NOWRAP valign=top width="100">
              <button class=grid_menu>Net Amount</button>
            </td>
            <td class=gridHeader NOWRAP valign=top width="100">
              <button class=grid_menu>VAT Amount</button>
            </td>
             <td class=gridHeader NOWRAP valign=top width="75">
              <button class=grid_menu>VAT Rate %</button>
            </td>
            <td class=gridHeader NOWRAP valign=top width="100">
              <button class=grid_menu>Gross Amount</button>
            </td>
            <td class=gridHeader NOWRAP valign=top width="60">
              <button class=grid_menu>Adj. Count</button>
            </td>
            <td class=gridHeader NOWRAP valign=top>
              <button class=grid_menu onclick="Toggle_Sort('Action')">Action <font color=red>(key)</font></button>
            </td>
          </tr>
          <tr>
            <td colspan=10>
            <iframe frameborder=0 width="100%" height=350 id=GridData name=GridData src="manualAdjustmentInvoicingGrid.jsp"></iframe>
            </td>
          </tr>
        </table>
      </td>
