...
<%
  ...
  session.setAttribute("formname","ebillingUpload");
  String SQL;
...
<form name="ebillingUpload" method="post" action="ebillingUploadHandler.jsp">
...
<table id=1 border=0 width="100%">
  ...
  <tr>
   <td colspan=3>
	...
	<td valign="top" id=2>
	  <h3 align="center">Create Ebilling Upload Files</h3>
...
%>
            ...
            <tr>
              <td colspan="6"><b>Ebilling Upload Process:</b></td>
            </tr>
            <tr>
              <td><b>Status:</b></td>
