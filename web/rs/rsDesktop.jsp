...
<%
  ...
  session.setAttribute("formname","rsDesktop");
  String SQL;

  String action;
  String Menu_Headings[]={"Go To", "Options", "Reference Data"};
  String Options[][] = {{"Log Off","Load Summarised Call Data from SSBS",
    "Remove Incorrectly Posted Traffic",
    "Summarised Call Data Rating","Master Account Invoicing",
    "Manual Adjustment Invoicing","Suspended Summarised CDR Data",
    "Create Ebilling Upload Files","Audit Reporting","Customer Rates and Flags",
    "Customer Invoicing Reports","Unexpected Product NTS"},
    {"Close Current Call Month"," ","Refresh","View All Processes","Change Password"},
    {"Rating Scheme","Provider/Account/Product/Threshold",
    ""}};
...
<form name="rsDesktop" method="post" action="../rs/rsDesktopHandler.jsp">
...
<table id=1 border=0 width="100%">
  ...
  <tr>
   <td colspan=3>
	...
	<td valign="top" id=2>
	  <h2 align="left">Revenue Share Management Application</h2>
