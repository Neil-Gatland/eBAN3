...
<form name="callDataRating" method="post" action="callDataRatingHandler.jsp">
...
<table id=1 border=0 width="100%">
  ...
  <tr>
   <td colspan=3>
	...
	<td valign="top" id=2>
	  <h3 align="center">Summarised Call Data Rating</h3>
...
%>
            ...
            <tr>
              <td colspan="6"><b>Summarised Call Data Rating Process:</b></td>
            </tr>
            <tr>
              <td><b>Status:</b></td>
            ...
            <tr>
              <td class=mandatory><b>Re-rate RQR09
                <br><%=DBA.getListBox("rerateRQR09",RSB.getMode("rerateRQR09"),RSB.getRerateRQR09(),"",1,"style=\"width:70%\"",true)%>
              </td>
	    </tr>
	  </table><!--table 3-->
      </td>
