...
<%
  ...
  session.setAttribute("formname","loadSSBSData");
  String SQL;
  String Mode=RSB.getMode();
  String action;
  String Menu_Headings[]={"Go To", "Options"};
  String Options[][] = {{"Log Off","Revenue Share Desktop"},
    {"Submit","","Missing Data Identification","View Import Report","Refresh",
...
<form name="loadSSBSData" method="post" action="loadSSBSDataHandler.jsp">
...
<table id=1 border=0 width="100%">
  ...
  <tr>
   <td colspan=3>
	...
	<td valign="top" id=2>
	  <h3 align="center">Load Summarised Call Data from SSBS</h3>
...
%>
            ...
            <tr>
              <td colspan="6"><b>Load Summarised Call Data Process:</b></td>
            </tr>
            <tr>
              <td><b>Status:</b></td>
