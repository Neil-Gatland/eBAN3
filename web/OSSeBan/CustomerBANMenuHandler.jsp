...
<%
	...
	cuBAN.setGlobalCustomerId(BAN.getGlobalCustomerId());
	cuBAN.setGlobalCustomerName(BAN.getGlobalCustomerName());
	cuBAN.setAccount_Id(BAN.getAccount_Id());
	cuBAN.getCustomer();
        %>
          <jsp:forward page="CustomerBAN.jsp"/>
	<%
      }
      else if (ButtonPressed.startsWith("Add an Account to a Customer"))
      {
	cuBAN.setGlobalCustomerId(BAN.getGlobalCustomerId());
	cuBAN.setGlobalCustomerName(BAN.getGlobalCustomerName());
	cuBAN.setAccount_Id("");
	...
	chBAN.setAccount_Id(BAN.getAccount_Id());
	...
	chBAN.setMode("Cease");
        ...
        chBAN.setAccount_for_List(BAN.getAccount_Id());
