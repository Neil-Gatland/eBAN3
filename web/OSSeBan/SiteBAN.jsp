		  ...
		  <td valign="top" height="341" colspan=2>
			...
			<td>
 			...
 			<td valign="top" class=<%=siteBAN.getClass("Country")%>><b><small>Country<br>
		      ...
		      <tr>
 			<td valign="top" class=<%=siteBAN.getClass("Billing_Region_Site")%>><b><small>Billing Region<br>
			  <%=DBA.getListBox("Billing_Region_Site",InputMode,Billing_Region,Global_Customer_Id,
                          1," style=\"width:78%;\"",true)%>
			</td>
		      </tr>
		      <tr>
			  ...
			  <input class=inp type="text" name="Geo_Code" maxlength="9" size="25" <%=siteBAN.getMode("Geo_Code")%> value="<%=siteBAN.getGeoCode()%>">
                          <br><div onClick="findGeo()">(click here to find a Geocode)</div>
			</td>
		      </tr>
                   </table>
                  </table>
