...
%>
  ...
  {
    if ((CreditMenu.Surname_Filter.value == "")&&
        (CreditMenu.CLI.value == "")&&
        (CreditMenu.AMEX_Staff_Number.selectedIndex == "0"))
    {
      if (CreditMenu.AMEX_Customer[CreditMenu.AMEX_Customer.selectedIndex].value == "")
      {
  ...
  <table id=1 width ="100%">
    ...
    <tr>
      <td colspan=3>
      <form name="CreditMenu" method="post" action="CreditMenuHandler.jsp">
      <%=
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" id=2>
	  <tr>
	    ...
	    <td valign="top"><br>
	      <h3 align="center"><b>Create Home Workers Voice Credit - Selection List</b></h3>
	       <%=Message%><br>
		    ...
		    <%=DBA.getListBox("AMEX_Customer","submit",Customer_Id,"")%>
                ...
                <tr>
                  <td align=left colspan=2><font color="#000000">
                    ...
                    and press search to select CLI records for the customer and then select
                    the entry that requires a credit adjustment.</font>
                  </td>
                </tr>
                <tr>
		  ...
		  <td align=left colspan=1><font color="#0000FF">User's CLI:</font>
                ...
                <tr>
                  <td width=100% colspan=4 class=bluebold>
                    <iframe frameborder=0 width="100%" height=20 id=GridHeader name=GridHeader src="CLIGridHeader.jsp" scrolling=no>
                    </iframe>
	            <%=SU.isNull((String)session.getAttribute("Message"),"")%><br>
	            <%
	              session.setAttribute("formname","listCLIs");
		    ...
		    %>
	            <iframe frameborder=0 width="100%" height=350 id=GridData name=GridData src="CLIGrid.jsp" ></iframe>
	            <%}
                    else
                    {%>
