...
<%
    ...
    String system = request.getParameter("system")==null?"AMEX":(String)request.getParameter("system");
    ...
    String text = "For temporary, read-only access to Home Workers Voice Billing. " +
    " If you require an Home Workers Voice Billing user profile please contact '" + email + "'";
%>
	...
	<!-- this is a spacer column-->
	  ...
	  <td  valign ="Top"><a name="content"></a>
		...
		<td valign="top" height="45" width="598"  colspan=3>
		  <h1>Welcome to Home Workers Voice Billing</h1>
