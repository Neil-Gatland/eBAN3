...
<xsl:for-each select="rs_invoices/rs_invoice">
      <fo:page-sequence master-reference="front-page" initial-page-number="1" force-page-count="no-force">
                ...
                <fo:table-row>
                  ...
                  <fo:table-cell>
                      <fo:block font="6pt Helvetica">
                        <fo:inline font-weight="bold"><xsl:value-of select="company_address/company_name"/></fo:inline>
                      </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  <fo:table-cell>
                      <fo:block font="6pt Helvetica">
                        <xsl:value-of select="company_address/company_address_literal"/>
                      </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  <fo:table-cell>
                      <fo:block font="6pt Helvetica">
                        <xsl:value-of select="company_address/company_details"/>
                      </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  <fo:table-cell>
                      <fo:block font="6pt Helvetica">
                        <xsl:value-of select="company_address/vat_details"/>
                      </fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-body>
                ...
                <fo:table-row>
                  <fo:table-cell height="0.5cm" padding-left="1cm">
                    <fo:block font="10pt Helvetica">
                      <fo:inline font-weight="bold"><xsl:value-of select="provider/name"/></fo:inline>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  <fo:table-cell height="0.5cm" padding-left="1cm">
                    <fo:block font="10pt Helvetica">
                      <fo:inline font-weight="bold"><xsl:value-of select="provider/address_line1"/></fo:inline>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  <fo:table-cell height="0.5cm" padding-left="1cm">
                    <fo:block font="10pt Helvetica">
                      <fo:inline font-weight="bold"><xsl:value-of select="provider/address_line2"/></fo:inline>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  <fo:table-cell height="0.5cm" padding-left="1cm">
                    <fo:block font="10pt Helvetica">
                      <fo:inline font-weight="bold"><xsl:value-of select="provider/address_line3"/></fo:inline>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  <fo:table-cell height="0.5cm" padding-left="1cm">
                    <fo:block font="10pt Helvetica">
                      <fo:inline font-weight="bold"><xsl:value-of select="provider/address_line4"/></fo:inline>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  <fo:table-cell height="0.5cm" padding-left="1cm">
                    <fo:block font="10pt Helvetica">
                      <fo:inline font-weight="bold"><xsl:value-of select="provider/address_line5"/></fo:inline>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  <fo:table-cell padding-bottom="1cm" height="0.5cm" padding-left="1cm">
                    <fo:block font="10pt Helvetica">
                      <fo:inline font-weight="bold"><xsl:value-of select="provider/address_line6"/></fo:inline>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                    ...
                    <fo:table table-layout="fixed" width="100%">
                      ...
                      <fo:table-body>
                        <fo:table-row>
                          ...
                          <fo:table-cell>
                            <fo:block font="10pt Helvetica">
                              <fo:inline font-weight="bold"><xsl:value-of select="invoice_number"/></fo:inline>
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell>
                            <fo:block font="10pt Helvetica">
                          ...
                          <fo:table-cell>
                            <fo:block font="10pt Helvetica">
                              <fo:inline font-weight="bold"><xsl:value-of select="tax_point_date"/></fo:inline>
                            </fo:block>
                          </fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                          ...
                          <fo:table-cell>
                            <fo:block font="10pt Helvetica">
                              <fo:inline font-weight="bold"><xsl:value-of select="master_account/master_account_number"/></fo:inline>
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell>
                            <fo:block font="10pt Helvetica">
                          ...
                          <fo:table-cell>
                            <fo:block font="10pt Helvetica">
                              <fo:inline font-weight="bold">
                                <xsl:choose>
                                  <xsl:when test="invoice_type='Invoice'">
                        ...
                        <fo:table-row>
                          ...
                          <fo:table-cell>
                            <fo:block font="10pt Helvetica">
                              <fo:inline font-weight="bold"><xsl:value-of select="provider/sap_vendor_number"/></fo:inline>
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell number-columns-spanned="2">
                            <fo:block font="10pt Helvetica">
                              <fo:inline font-weight="bold">
                                <xsl:choose>
                                  <xsl:when test="invoice_type='Invoice'">
                                    Page <fo:page-number/> of <fo:page-number-citation ref-id="{invoice_number}"/>
                                  </xsl:when>
                                  <xsl:otherwise/>
                                </xsl:choose>
                              </fo:inline>
                            ...
                            <fo:table table-layout="fixed" width="100%" background-color="#CCDAF2">
                              ...
                              <fo:table-body>
                                ...
                                <xsl:choose>
                                  <xsl:when test="invoice_type='Invoice'">
                                    <fo:table-row>
                                      <fo:table-cell text-align="right" height="0.6cm" number-columns-spanned="3">
                                        <fo:block font="10pt Helvetica">
                                          <fo:inline font-weight="bold">For the period <xsl:value-of select="start_date"/>
                                          to <xsl:value-of select="end_date"/></fo:inline>
                                        </fo:block>
                                      </fo:table-cell>
                                      ...
                                      <fo:table-cell
                                        ...
                                        text-align="right">
                                        <fo:block font="10pt Helvetica">
                                          <fo:inline font-weight="bold"><xsl:value-of select="net_amount"/></fo:inline>
                                        </fo:block>
                                      </fo:table-cell>
                                      <fo:table-cell>
                                        <fo:block/>
                                  ...
                                  <xsl:otherwise>
                                    <xsl:for-each select="adjustment_line">
                                      <fo:table-row>
                                ...
                                <fo:table-row>
                                 ...
                                 <fo:table-row>
                                  ...
                                  <fo:table-cell text-align="left" height="0.6cm">
                                     <fo:block font="10pt Helvetica">
                                       <fo:inline font-weight="bold"><xsl:value-of select="provider/bank_sort_code"/></fo:inline>
                                     </fo:block>
                                  </fo:table-cell>
                                   <fo:table-cell text-align="left" height="0.6cm">
                                     <fo:block font="10pt Helvetica">
                                ...
                                <fo:table-row>
                                 ...
                                 <fo:table-row>
                                  ...
                                  <fo:table-cell text-align="left" height="0.6cm">
                                     <fo:block font="10pt Helvetica">
                                       <fo:inline font-weight="bold"><xsl:value-of select="provider/bank_account_number"/></fo:inline>
                                     </fo:block>
                                  </fo:table-cell>
                                   <fo:table-cell text-align="left" height="0.6cm">
                                     <fo:block font="10pt Helvetica">
                                       <fo:inline font-weight="bold">VAT @ <xsl:value-of select="vat_rate"/>%</fo:inline>
                                     </fo:block>
                                   </fo:table-cell>
                                   <fo:table-cell text-align="right" height="0.6cm" padding-right="0.5%">
                                     <fo:block font="10pt Helvetica">
                                   ...
                                   <fo:table-cell
                                      ...
                                      text-align="right">
                                    <fo:block font="10pt Helvetica">
                                      <fo:inline font-weight="bold"><xsl:value-of select="vat_amount"/></fo:inline>
                                    </fo:block>
                                  </fo:table-cell>
                                  <fo:table-cell text-align="right" height="0.6cm">
                                    <fo:block/>
                                ...
                                <fo:table-row>
                                 ...
                                 <fo:table-row>
                                  ...
                                  <fo:table-cell text-align="left" height="0.6cm">
                                     <fo:block font="10pt Helvetica">
                                       <fo:inline font-weight="bold"><xsl:value-of select="provider/vat_number"/></fo:inline>
                                     </fo:block>
                                  </fo:table-cell>
                                   <fo:table-cell text-align="left" height="0.6cm">
                                     <fo:block font="10pt Helvetica">
                                   ...
                                   <fo:table-cell
                                      ...
                                      text-align="right">
                                    <fo:block font="10pt Helvetica">
                                      <fo:inline font-weight="bold"><xsl:value-of select="gross_amount"/></fo:inline>
                                    </fo:block>
                                  </fo:table-cell>
                                  <fo:table-cell text-align="right" height="0.6cm">
                                    <fo:block/>
                                ...
                                <fo:table-row>
                                  <fo:table-cell text-align="left" number-columns-spanned="6" padding="0.6cm">
                                    <fo:block font="10pt Helvetica">
                                     <fo:inline font-weight="bold"><xsl:value-of select="invoice_text/text"/></fo:inline>
                                    </fo:block>
                                  </fo:table-cell>
                                 </fo:table-row>
                              </fo:table-body>
      ...
      <xsl:choose>
        <xsl:when test="invoice_type='Invoice'">
          <fo:page-sequence master-reference="detail-sequence" force-page-count="no-force">
                ...
                <fo:table table-layout="fixed" width="100%">
                  ...
                  <fo:table-body>
                    ...
                    <fo:table-row>
                      ...
                      <fo:table-cell>
                        <fo:block font="10pt Helvetica">
                          <fo:inline font-weight="bold">Page <fo:page-number/> of <fo:page-number-citation ref-id="{invoice_number}"/></fo:inline>
                        </fo:block>
                      </fo:table-cell>
                      <fo:table-cell>
                        <fo:block/>
            ...
            <fo:flow flow-name="xsl-region-body">
              <fo:block>
                <xsl:for-each select="call_month">
                  <fo:table table-layout="fixed" width="80%">
