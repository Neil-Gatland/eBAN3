  ...
  public String getMenu_Bar()
  {
	...
	try
	{
	  ...
	  { //First set the menu bar heading
	    ...
	    if (Heading != "Go To")
	    {
	      HTML.append("<TABLE cellSpacing=0 cellPadding=0 width=225px border=2>\n");
	    }
	    else
	    {
	      HTML.append("<TABLE cellSpacing=0 cellPadding=0 width=225px border=2>\n");
		...
		else if (Option.compareTo("Log Off")==0)
		{
		  HTML.append("\"location.href='../GCTBWeb/Login.jsp?type=l'\">");
		}
		else if (Option.compareTo("Desktop")==0)
		{
		  HTML.append("\"location.href='../GCTBWeb/newDesktop.jsp'\">");
		}
		...
		else if (Option.equals("Show Rejects"))
		{
  		  HTML.append("\"checkRejectsToShow()\">");
		}
		else if (Option.equals("Show Exceptions"))
		{
  		  HTML.append("\"checkExceptionsToShow()\">");
		}
...
/*****************************************************************************************/
  public String getBANMenu_Bar(String Menu,String Mode, String Action)
  {
	...
	if ((Menu.endsWith("BAN")) || (Menu.startsWith("List")))
	{
	  ...
	  BAN_Option_Array[0][2]=groupName.equals("MANS")?"Close":fromEdify?"":"Log Off";
	}
	else if (Menu.compareTo("Welcome") == 0)
	{
	  ...
	  BAN_Option_Array[0][3]=groupName.equals("MANS")?"Close":fromEdify?"":"Log Off";
	}
	else if (Menu.compareTo("Menu") == 0)
	{
	  ...
	  BAN_Option_Array[0][0]=groupName.equals("MANS")?"Close":fromEdify?"":"Log Off";
	  BAN_Option_Array[0][1]=fromEdify?"Connect to Desktop":"Desktop";
	  BAN_Option_Array[0][2]="Main Menu";
	  BAN_Option_Array[0][3]="";

	  BAN_Option_Array[1][0]="Clear";
	  BAN_Option_Array[1][1]="Use Previous Values";
	  BAN_Option_Array[1][2]="Raise Query";
...
/*******************************************************************************/
  public String getBANMenu_Bar(String Menu,String Mode, String Action,String System)
  {
	...
	if ((Menu.endsWith("BAN")) || (Menu.startsWith("List")))
	{
	  ...
	  BAN_Option_Array[0][0]=(System.equals("OSS")?"":"Main Menu");
          ...
          else if ((System.equals("GCB")) || (System.equals("OSS")))
          {
            BAN_Option_Array[0][0]=fromEdify?"":"Log Off";
            BAN_Option_Array[0][1]=fromEdify?"":"Desktop";
            BAN_Option_Array[0][2]=System.equals("OSS")?"Create BAN Menu":"Account Administration Main Menu";
            BAN_Option_Array[0][3]=System.equals("OSS")?"":"Create BAN Menu";
          }
          else
          {
	...
	else if ((Menu.startsWith("Test")))
	{
	  ...
	  Standard_Menu_Headings[1]="Options";
	  BAN_Option_Array[0][0]="Main Menu";
	  BAN_Option_Array[0][1]=groupName.equals("MANS")?"Close":fromEdify?"":"Log Off";
	}
	else if (Menu.compareTo("Welcome") == 0)
	{
	  Standard_Menu_Headings[0]="Go To";
	  BAN_Option_Array[0][0]=groupName.equals("MANS")?"Close":fromEdify?"":"Log Off";
	  BAN_Option_Array[0][1]=(System.equals("OSS")||System.equals("GCB"))?groupName.equals("MANS")?"":(fromEdify?"Connect to Desktop":"Desktop"):"";
	  BAN_Option_Array[0][2]="";
	  BAN_Option_Array[0][3]="";
	}
	else if (Menu.compareTo("Report") == 0)
	{
	  ...
	  BAN_Option_Array[1][1]="Raise Query";
	}
	else if (Menu.compareTo("Menu") == 0)
	{
	  Standard_Menu_Headings[0]="Go To";
	  ...
	  Standard_Menu_Headings[2]="";

	  BAN_Option_Array[0][0]=groupName.equals("MANS")?"Close":fromEdify?"":"Log Off";
	  BAN_Option_Array[0][1]=(System.equals("OSS")||System.equals("GCB"))?groupName.equals("MANS")?"":(fromEdify?"Connect to Desktop":"Desktop"):"";
	  //BAN_Option_Array[0][1]="";
	  BAN_Option_Array[0][2]=(System.equals("OSS")?"":"Main Menu");
	  BAN_Option_Array[0][3]="";
	...
	if (Menu.endsWith("BAN"))
	{
	  ...
	  if (Action.compareTo("Authorise") == 0)
	  {
            if ((System.equals("GCB")) || (System.equals("OSS")))
            {
	      BAN_Option_Array [0][4]=isDirect?"":"Back To List";
            }
            else
            {
	  ...
	  else
	  {
	    ...
	    BAN_Option_Array [1][2]=System.equals("AdHoc")?
            ...
            if (System.equals("AdHoc") && !groupName.equals("STP"))
              ...
              BAN_Option_Array [1][3]="Raise Query";
	  }
	}
	...
	try
	{
	  while (BAN_Menu_Headings.hasMoreElements())
	  {
		...
		else if (Option.equals("Account Administration Main Menu"))
		{
		  HTML.append("\"location.href='Welcome.jsp'\">");
		}
		else if (Option.compareTo("Log Off")==0)
  ...
  public void main (String[] args)
  {
	...
	//Menu_Option.addElement("Create Customer BAN Menu");
        //Menu_Option.addElement("Log Off");
